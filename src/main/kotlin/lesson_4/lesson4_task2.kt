...
fun main() {
    ...
    println(
        "Груз с весом $oneCargoKg кг и объемом $oneCargoLiter л соответствует категории 'Average':" +
                " $oneAverageCargo"
    )

    println(
        "Груз с весом $twoCargoKg кг и объемом $twoCargoLiter л соответствует категории 'Average':" +
                " $twoAverageCargo"
    )
